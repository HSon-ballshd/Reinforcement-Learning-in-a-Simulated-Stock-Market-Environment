"""
Regime classifier — 5 models trained on macro-regime labels.

Trained on data/regime_dataset.parquet (generated by Sim).
Hypothesis H2: classifier beats random guessing (1/4 = 25%).
Labels are 4 macro-regimes: Stable, Bull, Bear, Chaotic.
"""
...
# Macro-regime labels (6 underlying modes collapsed into 4 observable groups)
REGIME_NAMES = {
    0: 'Stable',
    1: 'Bull',
    2: 'Bear',
...
# Underlying JS mode → macro-regime mapping:
#   Stable (0)    → Stable (0)
#   Bullish (1)   → Bull  (1)
#   Bearish (2)   → Bear  (2)
#   Strong Bull (3) → Bull  (1)
#   Strong Bear (4) → Bear  (2)
#   Chaotic (5)   → Chaotic (3)
MODE_TO_MACRO = {0: 0, 1: 1, 2: 2, 3: 1, 4: 2, 5: 3}


def macro_regime(underlying_mode: int) -> int:
    """Collapse a 6-class underlying mode into a 4-class macro-regime."""
    return MODE_TO_MACRO[underlying_mode]
